...
const int _thirdAccentValue = 0xFFFF4E84;
 ...
 const MaterialColor mcgpalette0 = MaterialColor(_mcgpalette0PrimaryValue, <int, Color>{
  50: Color(0xFFFBF9F5),
  100: Color(0xFFF5F1E5),
  200: Color(0xFFEEE8D4),
  300: Color(0xFFE7DEC2),
  400: Color(0xFFE2D7B5),
  500: Color(_mcgpalette0PrimaryValue),
  600: Color(0xFFD9CBA0),
  700: Color(0xFFD4C497),
  800: Color(0xFFCFBE8D),
  900: Color(0xFFC7B37D),
});
 const int _mcgpalette0PrimaryValue = 0xFFDDD0A8;
 ...
 const MaterialColor mcgpalette0Accent = MaterialColor(_mcgpalette0AccentValue, <int, Color>{
  ...
  400: Color(0xFFFFF8E6),
  700: Color(0xFFFFF1CD),
});
